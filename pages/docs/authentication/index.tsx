...
function HeaderUserbox() {
  ...
  return (
    <>
      <Head>
        <title>Authentication - Tokyo NextJS Typescript Admin Dashboard</title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo NextJS Typescript Admin Dashboard includes four separate
            ...
            <Typography paragraph>
              ...
              default, Tokyo NextJS Typescript Admin Dashboard comes with JWT
              Web Tokens enabled.
            </Typography>
            <Typography paragraph>
